...
<body bgcolor="#FFF0F5">
    <h5><a href="../index.php" style="float: right; margin-right:50px; color:black">BackToHome</a></h5><br>
    <h1 align='center' style="color: #880085;font-size:60px">Admin Login</h1>
