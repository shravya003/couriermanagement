...
<html lang="en">
    ...
    <body><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="color:#9F2B68">Register</h2>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                        <input type="submit" name="submit" value="Register" style="background-color:#DDA0DD; border-radius: 10px; width: 100px; height: 40px;" />
